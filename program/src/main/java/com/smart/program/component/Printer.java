package com.smart.program.component;
...
public class Printer {
    ...
    public static final String USER = "675406203@qq.com";//*必填*：账号名
    public static final String UKEY = "zPq5QvNYNyICFa6b";//*必填*: 注册账号后生成的UKEY
    public static final String SN = "918501351";//*必填*：打印机编号，必须要在管理后台里添加打印机或调用API接口添加之后，才能调用API
...
//			System.out.println(method3);
    ...
    private static String printOrder(String sn, List<OrderItemDTO2> orderItemDTO2s) {
        //标签说明：
        //单标签:
        //"<BR>"为换行,"<CUT>"为切刀指令(主动切纸,仅限切刀打印机使用才有效果)
        //"<LOGO>"为打印LOGO指令(前提是预先在机器内置LOGO图片),"<PLUGIN>"为钱箱或者外置音响指令
        ...
        content += "--------------------------------<BR>";
        for (OrderItemDTO2 orderItemDTO2 : orderItemDTO2s) {
